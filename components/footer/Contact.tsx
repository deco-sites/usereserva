          ...
          {content.map((item) => (
              <div class="flex flex-col gap-2">
                ...
                {item.items.map((items) => (
                   ...
                   <div class="ml-2.5">
                 <a href={items.href} class="block link link-secondary font-reserva-sans text-accent-content">
                   {items.label}
                 </a>
                 <span class="text-xs whitespace-break-spaces">{items.description}</span>
                   </div>
               </li>
                ))}
                </ul>
